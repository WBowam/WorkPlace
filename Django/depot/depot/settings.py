...
HERE=os.path.dirname(os.path.abspath(__file__)).replace('\\','/').decode('utf-8')
STATICFILES_DIRS = (
...
SECRET_KEY = '0-9w0-yni9#rio#=n!@=)u2=p178-p2uhlh6&amp;6lmdz$rurqpng'
...
TEMPLATE_DIRS = (
    ...
    ('/home/tulpar/Workplace/WorkPlace/Django/depot/templates'),
